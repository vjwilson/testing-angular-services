...
describe( 'JSON Service', function() {
  ...
  it('should get an array of users', function() {
    ...
    jsonService.getUsers().then(function(users) {
  ...
  /**
   * Helper function to return a fixture for the mock HTTP request
   *   to the getUsers function
   *
  ...
  /**
   * Helper function to return a fixture for the mock HTTP request
   *   to the getOneUser function
   *
   * @return {object} A user object
   */
  function getOneUserResponse() {
    return {
      "id": 2,
      "name": "Ervin Howell",
      "username": "Antonette",
